...
<div class="beij_center">
    <div class="qieh_cs_beij">
        ...
        <div class="guiytongc">
            <div class="guiytc_anniu"><a href="#">贵阳WangID通城>></a></div>
            <div class="zhoub_chengs">
                <span>周边城市推荐：</span>
                <span><a href="#">贵阳</a></span>
                <span><a href="#">安顺</a></span>
                <span><a href="#">毕节</a></span>
                <span><a href="#">六盘水</a></span>
...
<body> 
  ...
  <script src="js/qieh_cs/changecity.js?v=10"></script>
  <script src="js/qieh_cs/referrer4.js"></script>
</div>
<!--底部-->
<div class="jianj_dib">
	<div class="beia_hao">
